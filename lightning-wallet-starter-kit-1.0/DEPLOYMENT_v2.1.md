...
```bash
install -m 600 scripts/fixtures/wallet-acceptance.template.json /secure/acceptance/wallet-acceptance-v2.41.json
```
...
```bash
./scripts/verify-wallet-acceptance.sh /secure/acceptance/wallet-acceptance-v2.41.json
./scripts/verify-wallet-acceptance-live.sh /secure/acceptance/wallet-acceptance-v2.41.json
sha256sum /secure/acceptance/wallet-acceptance-v2.41.json
```
