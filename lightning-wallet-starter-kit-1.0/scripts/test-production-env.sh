...
sh -n "$SCRIPT_DIR/check-production-env.sh" "$SCRIPT_DIR/deploy.sh" "$SCRIPT_DIR/rollback-release.sh" "$SCRIPT_DIR/verify-production.sh" "$SCRIPT_DIR/verify-final-readiness.sh" "$SCRIPT_DIR/verify-live-providers.sh" "$SCRIPT_DIR/test-verification-gates.sh"
