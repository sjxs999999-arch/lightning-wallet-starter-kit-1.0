...
export interface WalletControlResult { walletId:string; address:string; pass:boolean; signatureValid:boolean; addressMatched:boolean; errorCode?:'DECRYPT_FAILED'|'PRIVATE_KEY_INVALID'|'SIGNATURE_FAILED'|'ADDRESS_MISMATCH' }
