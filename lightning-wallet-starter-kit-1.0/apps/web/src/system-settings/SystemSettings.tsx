...
type Capabilities = {
  ...
  features: Capability[];
  readiness?: Readiness;
  security: { privateKeysUploaded: boolean; serverSigning: boolean; analytics: boolean; sessionRevocation: boolean; httpOnlySession: boolean; csrfProtection: boolean; defaultDenyApi: boolean; contentSecurityPolicy: boolean; metadataOnlyDiagnostics: boolean; automaticSessionRecovery: boolean; workerOnlyExportValidation: boolean; zeroizedKeyBuffers: boolean };
};
