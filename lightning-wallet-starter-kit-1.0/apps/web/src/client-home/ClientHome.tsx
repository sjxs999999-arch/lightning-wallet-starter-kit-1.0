...
type Readiness = { finalApproval: boolean; walletAcceptanceRequired: boolean; externalBlockers: { code: string; label: string }[]; mainnet: { walletSession: boolean; walletCenterBroadcast: boolean; execution: boolean; swap: boolean; launchpad: boolean; bridge: boolean } };
...
export function ClientHome() {
  ...
  return <>
    ...
    <div className="client-home-stats">
      <section className="panel"><span>客户端版本</span><strong>{capabilities?.version ?? '2.41.0'}</strong><small>正式运行 · 交易门禁</small></section>
