...
- Current code candidate commit: `c670e31`
...
5. Deploy code candidate `c670e31` after the platform write-authorization/usage gate is available, then repeat production HTTP and browser-console acceptance.
